...
class ParamikoSSHVendor:
    ...
    def run_command(self, host: Any, command: Any, username: Optional[Any] = ..., port: Optional[Any] = ..., password: Optional[Any] = ..., pkey: Optional[Any] = ..., key_filename: Optional[Any] = ..., **kwargs: Any) -> _ParamikoWrapper: ...
