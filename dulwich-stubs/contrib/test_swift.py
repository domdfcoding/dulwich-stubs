...
__all__ = [
		...
		"FakeSwiftConnector",
		"TestSwiftRepo",
		"TestSwiftInfoRefsContainer",
		"TestSwiftConnector",
		"SwiftObjectStoreTests"
		]
...
class TestSwiftConnector(TestCase):
	...
	def test_get_object_stat(self):
		with patch(
				'geventhttpclient.HTTPClient.request', lambda *args: Response(headers={'content-length': '10'})
				):
