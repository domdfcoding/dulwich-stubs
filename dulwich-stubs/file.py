...
__all__ = ["ensure_dir_exists", "GitFile", "FileLocked"]
...
class _GitFile(object):
	...
	PROXY_PROPERTIES = {'closed', 'encoding', 'errors', 'mode', 'name', 'newlines', 'softspace'}
	PROXY_METHODS = (
			'__iter__',
			'flush',
			'fileno',
	...
	def __init__(self, filename, mode, bufsize):
		...
		try:
			fd = os.open(self._lockfilename, os.O_RDWR | os.O_CREAT | os.O_EXCL | getattr(os, "O_BINARY", 0))
		except FileExistsError:
