...
# this package
from dulwich.object_store import MissingObjectFinder, ObjectStoreIterator, _collect_filetree_revs
from dulwich.objects import Commit, Tag

__all__ = ["GreenThreadsMissingObjectFinder", "GreenThreadsObjectStoreIterator"]
...
class GreenThreadsMissingObjectFinder(MissingObjectFinder):
	...
	def __init__(
			self, object_store, haves, wants, progress=None, get_tagged=None, concurrency=1, get_parents=None
			):
