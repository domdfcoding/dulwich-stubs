...
from typing import (
    Any, Callable, Dict, IO, Iterable, Iterator, List, NoReturn, Optional, Set, Tuple, Type, TypeVar, Union,
    )
...
class BaseRepo:
    ...
    def generate_pack_data(self, have: List[Union[str, bytes]], want: List[Union[str, bytes]], progress: Optional[Callable] = ..., ofs_delta: Optional[Any] = ...): ...
    ...
    def do_commit(self, message: Optional[Union[str, bytes]] = ..., committer: Optional[Union[str, bytes]] = ..., author: Optional[Union[str, bytes]] = ..., commit_timestamp: Optional[float] = ..., commit_timezone: Optional[float] = ..., author_timestamp: Optional[float] = ..., author_timezone: Optional[float] = ..., tree: Optional[Any] = ..., encoding: Optional[Union[str, bytes]] = ..., ref: bytes = ..., merge_heads: Optional[Any] = ...) -> bytes: ...
...
class Repo(BaseRepo):
    ...
    def clone(self, target_path: Union[str, bytes], mkdir: bool = ..., bare: bool = ..., origin: bytes = ..., checkout: Optional[Any] = ...) -> "Repo": ...
    def reset_index(self, tree: Optional[Any] = ...): ...
    def get_config(self) -> ConfigFile: ...
    def get_description(self) -> Optional[Union[str, bytes]]: ...
    def set_description(self, description: Any) -> None: ...
    @classmethod
    def init(cls, path: Any, mkdir: bool = ...) -> "_R": ...
    @classmethod
    def init_bare(cls, path: Any, mkdir: bool = ...) -> "_R": ...
    create: Any = ...
    def close(self) -> None: ...
