...
from dulwich.protocol import ReceivableProtocol as ReceivableProtocol
from dulwich.repo import BaseRepo as BaseRepo, NotGitRepository as NotGitRepository, Repo as Repo
from dulwich.server import (
    DEFAULT_HANDLERS as DEFAULT_HANDLERS, DictBackend as DictBackend,
    generate_info_refs as generate_info_refs, generate_objects_info_packs as generate_objects_info_packs, Handler,
    )
from typing import Any, AnyStr, Callable, Dict, IO, Iterator, List, Match, Optional, Pattern, Tuple, Type, Union
...
class HTTPGitRequest:
    ...
    def __init__(self, environ: Dict[str, Any], start_response: Any, dumb: bool=..., handlers: Optional[Any]=...) -> None: ...
    def add_header(self, name: str, value: str) -> None: ...
    def respond(self, status: str=..., content_type: Optional[str]=..., headers: Optional[List[Tuple[str, str]]]=...) -> Any: ...
...
class HTTPGitApplication:
    ...
    fallback_app: Any = ...
    def __init__(self, backend: Any, dumb: bool=..., handlers: Optional[Any]=..., fallback_app: Optional[Any]=...) -> None: ...
    def __call__(self, environ: Dict[str, Any], start_response: Any) -> Callable[[HTTPGitRequest, Any, Match[str]], Iterator[AnyStr]]: ...
...
def make_wsgi_chain(backend: Any, dumb: bool=..., handlers: Optional[Any]=..., fallback_app: Optional[Any]=...) -> LimitedInputFilter: ...
