...
class RefsContainer:
    ...
    def remove_if_equals(self, name: Any, old_ref: Any, committer: Optional[Any] = ..., timestamp: Optional[Any] = ..., timezone: Optional[Any] = ..., message: Optional[Any] = ...) -> bool: ...
...
class DictRefsContainer(RefsContainer):
    ...
    def set_symbolic_ref(self, name: Any, other: Any, committer: Optional[Any] = ..., timestamp: Optional[Any] = ..., timezone: Optional[Any] = ..., message: Optional[Any] = ...) -> None: ...
    def set_if_equals(self, name: Any, old_ref: Any, new_ref: Any, committer: Optional[Any] = ..., timestamp: Optional[Any] = ..., timezone: Optional[Any] = ..., message: Optional[Any] = ...) -> bool: ...
    def add_if_new(self, name: Any, ref: Any, committer: Optional[Any] = ..., timestamp: Optional[Any] = ..., timezone: Optional[Any] = ..., message: Optional[Any] = ...) -> bool: ...
