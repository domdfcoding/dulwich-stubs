...
class Pattern(object):
	...
	def __eq__(self, other: object) -> bool:
		return (
				isinstance(other, type(self)) and self.pattern == other.pattern
				and self.ignorecase == other.ignorecase
				)

	def __repr__(self) -> str:
		return f"{typeself.__name__}({self.pattern!r}, {self.ignorecase!r})"
...
class IgnoreFilter(object):
	...
	def __repr__(self) -> str:
		...
		if path is not None:
			return f"{typeself.__name__}.from_path({path!r})"
		else:
...
class IgnoreFilterManager(object):
	...
	def __repr__(self) -> str:
		return "{}({}, {!r}, {!r})".format(
				typeself.__name__, self._top_path, self._global_filters, self._ignorecase
				)
