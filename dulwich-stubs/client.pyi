from dulwich.config import get_xdg_config_home_path as get_xdg_config_home_path
...
UPLOAD_CAPABILITIES: Any
RECEIVE_CAPABILITIES: Any
...
class GitClient:
    ...
    def get_url(self, path: Any) -> None: ...
    @classmethod
    def from_parsedurl(cls, parsedurl: Any, **kwargs: Any) -> None: ...
    def send_pack(self, path: Any, update_refs: Any, generate_pack_data: Any, progress: Optional[Any] = ...) -> None: ...
    def fetch(self, path: Any, target: Any, determine_wants: Optional[Any] = ..., progress: Optional[Any] = ..., depth: Optional[Any] = ...): ...
    def fetch_pack(self, path: Any, determine_wants: Any, graph_walker: Any, pack_data: Any, progress: Optional[Any] = ..., depth: Optional[Any] = ...) -> None: ...
    def get_refs(self, path: Any) -> None: ...
...
class TraditionalGitClient(GitClient):
    ...
    def send_pack(self, path: Any, update_refs: Any, generate_pack_data: Any, progress: Optional[Any] = ...): ...
    def fetch_pack(self, path: Any, determine_wants: Any, graph_walker: Any, pack_data: Any, progress: Optional[Any] = ..., depth: Optional[Any] = ...): ...
...
def ParamikoSSHVendor(**kwargs: Any): ...
...
def default_urllib3_manager(config: Any, pool_manager_cls: Optional[Any] = ..., proxy_manager_cls: Optional[Any] = ..., **override_kwargs: Any): ...
...
def get_transport_and_path_from_url(url: Any, config: Optional[Any] = ..., **kwargs: Any): ...
def parse_rsync_url(location: Any): ...
def get_transport_and_path(location: Any, **kwargs: Any): ...

DEFAULT_GIT_CREDENTIALS_PATHS: Any

def get_credentials_from_store(scheme: Any, hostname: Any, username: Optional[Any] = ..., fnames: Any = ...): ...
