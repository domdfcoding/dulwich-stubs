...
def write_cache_entry(
	f: IO, entry: Tuple[Any, Any, Any, Any, Any, Any, Any, Any, Any, Any, Any]
) -> None: ...
def read_index(f: BinaryIO) -> Any: ...
def read_index_dict(f: IO): ...
def write_index(
	f: BinaryIO, entries: List[Any], version: Optional[int] = ...
) -> Any: ...
def write_index_dict(
	f: BinaryIO, entries: Dict[bytes, IndexEntry], version: Optional[int] = ...
) -> None: ...
...
class Index:
	...
	def changes_from_tree(
		self, object_store: Any, tree: Any, want_unchanged: bool = ...
	): ...
...
def index_entry_from_stat(
	stat_val: Any, hex_sha: bytes, flags: int, mode: Optional[int] = ...
) -> Any: ...
...
def get_unstaged_changes(
	index: Index, root_path: Any, filter_blob_callback: Any = ...
) -> Any: ...
...
def iter_fresh_entries(
	paths: Any, root_path: Any, object_store: Optional[BaseObjectStore] = ...
) -> Any: ...
