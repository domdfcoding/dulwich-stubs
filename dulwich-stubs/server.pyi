...
class Handler:
	...
	stateless_rpc: Any = ...
	def __init__(
		self, backend: Any, proto: Any, stateless_rpc: Optional[Any] = ...
	) -> None: ...
...
class UploadPackHandler(PackHandler):
	...
	def get_tagged(
		self, refs: Optional[Dict] = ..., repo: Optional[Repo] = ...
	) -> Dict: ...
	def handle(self) -> None: ...
...
class _ProtocolGraphWalker:
	...
	unshallow: Any = ...
	def __init__(
		self, handler: Any, object_store: Any, get_peeled: Any, get_symrefs: Any
	) -> None: ...
...
class UploadArchiveHandler(Handler):
	repo: Any = ...
	def __init__(
		self, backend: Any, args: Any, proto: Any, stateless_rpc: Optional[Any] = ...
	) -> None: ...
	def handle(self): ...
...
class TCPGitServer(socketserver.TCPServer):
	...
	backend: Any = ...
	def __init__(
		self, backend: Any, listen_addr: Any, port: int = ..., handlers: Optional[Any] = ...
	) -> None: ...
