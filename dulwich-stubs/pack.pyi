...
def iter_sha1(iter: Any): ...  # noqa: A002  # pylint: disable=redefined-builtin
def load_pack_index(path: Any) -> PackIndex: ...
def load_pack_index_file(path: Any, f: Any) -> PackIndex: ...
def bisect_find_sha(start: Any, end: Any, sha: Any, unpack_name: Any) -> Optional[Any]: ...
...
def obj_sha(type: Any, chunks: Any): ...  # noqa: A002  # pylint: disable=redefined-builtin
...
class PackData:
	...
	@classmethod
	def from_file(cls, file: Any, size: Optional[Any] = ...): ...
