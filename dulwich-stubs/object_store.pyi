...
class BaseObjectStore:
	...
	def add_pack_data(
		self, count: int, pack_data: Iterable[Any], progress: Optional[Any] = ...
	): ...
	def tree_changes(
		self,
		source: Any,
	...
	def iter_tree_contents(
		self, tree_id: Any, include_trees: bool = ...
	) -> Iterator[TreeEntry]: ...
...
class DiskObjectStore(PackBasedObjectStore):
	...
	pack_compression_level: Any = ...
	def __init__(
		self, path: Any, loose_compression_level: int = ..., pack_compression_level: int = ...
	) -> None: ...
	@classmethod
...
class ObjectStoreGraphWalker:
	...
	shallow: Any = ...
	def __init__(
		self, local_heads: Any, get_parents: Any, shallow: Optional[Any] = ...
	) -> None: ...
