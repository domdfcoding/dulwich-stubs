...
__all__ = ["InvalidUserIdentity", "get_user_identity", "check_user_identity", "parse_graftpoints", "serialize_graftpoints", "ParentsProvider", "BaseRepo", "read_gitfile", "UnsupportedVersion", "Repo", "MemoryRepo"]
            ...
            try:
                ...
                warnings.warn(
                    'ref {} points at non-present sha {}'.format(
                        ref.decode'utf-8', 'replace', sha.decode(),
                    UserWarning)
                continue
            else:
    ...
    def _get_object(self, sha, cls):
        ...
        if not isinstance(ret, cls):
            if cls is Commit:
                ...
                raise Exception("Type invalid: {!r} != {!r}".format(
    ...
    def do_commit(self, message=None, committer=None,
        ...
        if ref is None:
            ...
            if not ok:
                ...
                raise CommitError("{} changed during commit".format(ref))
